            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-6 border-t border-slate-200">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm font-semibold text-amber-600 uppercase tracking-wider">Events Hosted</p>
                </div>
                <div className="flex flex-col gap-1">
                  <h4 className="text-4xl font-bold text-slate-900">100%</h4>
                  <p className="text-sm font-semibold text-amber-600 uppercase tracking-wider">Client Satisfaction</p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white py-24 border-t border-slate-100">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-slate-600 leading-relaxed">Easily accessible with ample parking, making it convenient for all your guests to arrive stress-free and ready to celebrate.</p>
              </div>
              ...
              <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-slate-600 leading-relaxed">Our experienced staff is committed to assisting you at every step, ensuring a flawless execution of your event from start to finish.</p>
              </div>
              ...
              <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-slate-600 leading-relaxed">From cozy intimate setups to grand arrangements, our facilities effortlessly adapt to your specific theme and guest count up to 500 guests.</p>
              </div>
            </div>
          </div>
        </section>
